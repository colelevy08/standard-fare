...
const StickyMobileCTA = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[80] md:hidden safe-bottom">
      <div className="bg-navy/95 backdrop-blur-sm border-t border-cream/10 px-4 py-3 flex gap-3">
